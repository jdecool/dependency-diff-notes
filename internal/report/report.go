// Package report renders a dependencydiff.Report into the Markdown body of
// the Bot Comment (see CONTEXT.md): the single comment the bot maintains on
// a Change Request, identified by a hidden marker and updated in place on
// every pipeline run.
package report
